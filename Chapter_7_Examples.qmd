...
In this exercise students should practice analyzing data with [*R*](https://cran.r-project.org/) and [*RStudio*](https://posit.co/products/open-source/rstudio/). These skills will serve them well in the progress of their study time and in the future. The internet provides countless further examples. Besides, there exist very good text books (z.B., @lê2015, @chapman2019).
...
::: callout-tip
As the results of the $\chi^{2}$-test is significant (`r triangle_test$p.value`), we have to reject H~0~. Thus, consumers can reliably distinguish between the new and the old lasagna. 
:::
