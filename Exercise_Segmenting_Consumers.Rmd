...
R analysis script presenting the solutions for the exercise in Sensory Marketing regarding Lichters et al.[-@Lichters.2021c] . In one of the questions students are asked to estimate the appropriate samples size for a replication of Study 1's findings (under $\alpha$=5%, Power=0.8).
...
pacman::p_load(tidyverse, dplyr, tidyselect, osfr)
