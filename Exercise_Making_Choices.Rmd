...
subtitle: 'Solutions - Exercise: Making choices while smelling...'
...
R analysis script presenting the solutions for the exercise in Sensory Marketing regarding Biswas et al. [-@Biswas.2014]. In one of the questions students are asked to estimate the appropriate samples size for a replication of Study 1b's findings (under $\chi^{2}$-test, $\alpha$=5%, Power=0.8).
...
We use the function twice. The first time we assign the results to an object named 'CI_effect'. The second time we do not assign the results to an object, which is equivalent to printing the results to the screen.
