...
pacman::p_load(tidyverse, SensoMineR, sensR, pwr, downloadthis, openxlsx, labelled, lm.beta, ggstatsplot, jtools, interactions)
...
pacman::p_load(tidyverse, SensoMineR, sensR, pwr, openxlsx, labelled, lm.beta, ggstatsplot, jtools, interactions)
...
Overall, it seems as if males are losing their hearing capabilities faster than females, although the interaction is not statistically significant.
